...
| 功能 | 说明 |
| --- | --- |
| 今日学习（首页） | 学习调度中心：今日目标进度与打卡、到期错题 + 待巩固单词一键复习、**最薄弱语法点直达专练**、**词汇量基线（听/读对比）**、继续上次课程 |
...
| 阅读词汇量 | 「📖 阅读词汇量」：显示英文单词，4 选 1 选中文释义；估算方法与听力版相同，测的是「看得懂」的词汇量；听读可对比，历次成绩独立留档 |
| 查词典 | 「📕 查词典」：跨册检索教材词表（第 1、2 册），支持发音、一键收藏生词；教材学习页单词行可深链跳转 |
| 情景对话 | 「💬 情景对话」：9 大生活场景、27 组角色扮演对话；看中文提示打出英文台词，逐步判分，练口语表达 |
...
└── public/              # 前端（原生 HTML/CSS/JS，零构建）
    ...
    └── js/              # 功能模块，一功能一文件，自注册标签页
        ...
        ├── vocabtest-ui.js     # 听/读词汇量共用 UI 辅助
...
| --- | --- | --- | --- |
| 第 1 册 | **72 / 72 课文课**（L1–143 奇数课） | 413 | 教材 + 题库 + 听写精读全文完成 |
| 第 2 册 | **96 / 96** | 499 | 教材 + 题库 + 精读短文全文完成；听写/背单词/词汇量测试已支持 |
