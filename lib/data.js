...
function invalidateDerivedCaches() {
  try { require('./dict').invalidateDictCache(); } catch (_) { /* */ }
  try { require('./wordlookup').invalidateLookupCache(); } catch (_) { /* */ }
  try { require('./word-index').invalidateWordIndex(); } catch (_) { /* */ }
  try { require('./word-pick').invalidateWordPickCache(); } catch (_) { /* */ }
}
reload();
